...
namespace Dali.Services.Revit
{
    ...
    public class AddDevicesInteractiveRequest : IExternalEventRequest
    {
        ...
        public void Execute(UIApplication app)
        {
            ...
            ISelectionFilter selectionFilter = new DaliCategorySelectionFilter(includedCategoryIds);
        ...
        // --- Selection Filter ---
        public class DaliCategorySelectionFilter : ISelectionFilter
        {
            private readonly HashSet<int> _categoryIds;
            public DaliCategorySelectionFilter(HashSet<int> ids) { _categoryIds = ids; }
